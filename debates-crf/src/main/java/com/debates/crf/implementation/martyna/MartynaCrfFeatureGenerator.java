...
import com.debates.crf.implementation.martyna.feature.DebateFeature;
...
public class MartynaCrfFeatureGenerator extends CrfFeatureGenerator<String, String> {
    ...
    public MartynaCrfFeatureGenerator(Iterable<? extends List<? extends TaggedToken<String, String>>> corpus,
                                     Set<String> tags) {
        super(corpus, tags);
    }
    ...
    private static final String[] PROPOSITION_BEGIN = new String[]{
            ...
            "powinniśmy", "powinny", "powinno", "powinna", "powinien", "powinni",
            "trzeba", "uważać","według", "zdaniem", "wolno", "należy",
            "myśleć",
            "gdyby"
    };

    private static final String[] REASON_BEGIN = new String[]{
            "ponieważ", "bo", "gdyż", "wtedy", "ale"
    };
    ...
    private void addPropositions()
    {
        for( String keyWord : PROPOSITION_BEGIN ) {
            setFilteredFeatures.add(new CrfFilteredFeature<>(
                    new DebateFeature( keyWord, Tag.PROPOSITION_START.toString() ),
                    new DebateFeatureFilter( keyWord, Tag.PROPOSITION_START.toString() ),
                    true
            ));
        }
    }
