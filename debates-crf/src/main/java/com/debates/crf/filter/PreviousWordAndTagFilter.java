 ...
 */
public class PreviousWordAndTagFilter extends Filter<String, String> {
    ...
    public PreviousWordAndTagFilter(String pos, String currentTag) {
        this.pos = pos;
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PreviousWordAndTagFilter other = (PreviousWordAndTagFilter) obj;
        if (currentTag == null)
        {
